...
public class StringManipulation {
	...
	//	String str ="Hello";   //string literal, use if know value beforehand
	//	str= new String ("Hello");    //or str= new String ("");  new keyword
       ...
       String para = "The quick brown fox jumps over the lazy dog.";
		...
		//HW:Write a program that prints last character of each word in a string
